              ...
              <div class="modal-body">
                  <form action="<?php echo base_url();?>index.php/home/form2" method="post"/>
                        ...
                        <div class="form-group">
                          ...
                          <input type="email" class="form-control" id="InputEmail1" placeholder="*Email Address:" name="email" required="required">
                        </div>
                        
                        <div class="form-group">                          
                          <input type="text" class="form-control" id="InputPhone" placeholder="Address:" name="phone">
                        </div>
                  
                        <div class="form-group">                          
                          <input type="text" class="form-control" id="InputPhone" placeholder="City:" name="phone">
                        </div>
                  
                        <div class="form-group">                          
                          <input type="text" class="form-control" id="InputPhone" placeholder="Zip:" name="phone">
                        </div>
                        ...
                        <div class="checkbox">
                            ...
                            <label class="label-popup">
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">As soon as possible</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">4-6 Weeks</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">6-12 Weeks</span>
                                <input type="checkbox" name=""> More than 3 months
                            </label>
                        </div>
                      <br/>
                        <div class="form-group">                        
                        ...
                        <div class="checkbox">
                            ...
                            <label class="label-popup">
                                <input type="checkbox" name=""> Full Home (We will be taking very little)
                                <br/>
                                <input type="checkbox" name=""> Downsizing (Leaving 1/2 of the contents)
                                <br/>
                                <input type="checkbox" name=""> Moving (1-2 rooms of items to sell)
                                <br/>
                                 <br/>
                            </label>
                        </div>
                        ...
                        <div class="checkbox">
                            ...
                            <label class="label-popup">
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Accessories</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Art</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">China</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Clothing</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Crystal</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Firearms</span>
                                
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Furniture</span>
                                <br/>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Garage Sales Items</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Gold/ Silver</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Jewelery</span>
                                
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Kitchen Items</span>
                                <br/>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Outdoor Items</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Rugs</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Sporting Goods</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Tools</span>
                                <input type="checkbox" name=""> <span style="padding-right: 22px;">Vehicles</span>
                               <br/><br/>
                            </label>
                        </div>                      
