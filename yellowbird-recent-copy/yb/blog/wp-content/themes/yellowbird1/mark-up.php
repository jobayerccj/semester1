        ...
        <div class="container">
            <div class="row section1">
                <div class="col-lg-12 text-center">
                    <img src="http://5.101.105.32/yb/images/Lawn.jpg" alt="Lawn"/>
                </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <form action="http://5.101.105.32/yb/index.php/home/form2" method="post"/>
                       
                        <div class="form-group">                        
                          
                            <input type="text" class="form-control" id="InputName" placeholder="*Name:" name="name" required="required" value="Corey Brown">
                        </div>
                        
                        <div class="form-group">                          
                          <input type="text" class="form-control" id="InputPhone" placeholder="Phone:" name="phone" value="123234">
                        </div>
                  
                        <div class="form-group">
                          
                          <input type="email" class="form-control" id="InputEmail1" placeholder="*Email Address:" name="email" required="required" value="asdas342@gmail.com">
                        </div>
                      ...
                      <br/>
                        ...
                        <div class="form-group">                             
                          <label class="label-popup"><img src="http://5.101.105.32/yb/captcha/1432022946.4588.jpg" width="340" height="60" style="border:0;" alt=" " /></label>
                          <input type="hidden" name="captcha1" value="KhMZgaMH">                          
                        </div>  
